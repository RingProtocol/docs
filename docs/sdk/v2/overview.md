...
Welcome to the Ring Protocol v2 SDK. To begin, we recommend looking at the [**Guides**](./guides/01-quick-start.md) and for deeper reference see the [**v2 SDK GitHub**](https://github.com/RingProtocol/v2-sdk) repo.


## Ring v2 SDK

- [**v2 SDK GitHub**](https://github.com/RingProtocol/v2-sdk)
