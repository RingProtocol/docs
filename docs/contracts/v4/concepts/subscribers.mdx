...
Subscribers, new in Ring v4, allow for liquidity-position owners to opt-in to a contract that receives _notifications_.
...
to risk their liquidity position and its underlying assets. In Ring v3, _liquidity mining_ was supported by fully transferring the 
