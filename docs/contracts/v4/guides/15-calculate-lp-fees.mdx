...
With hooks introduced in v4, [Dynamic Fees](../concepts/dynamic-fees) are possible and allow v4 pools to use flexible, responsive fee structures instead of fixed fee tiers.
...
In this guide we will go through how you can calculate LP position fee amounts in v4, specifically the **uncollected fees** and **total lifetime fees**.
