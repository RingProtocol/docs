...
The Ring front-end supports URL query parameters to allow for custom linking to the Ring frontend. Users and developers can use these query parameters to link to the Ring frontend with custom prefilled settings.
