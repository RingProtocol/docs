# Descriptor
[Git Source](https://github.com/RingProtocol/v4-periphery/blob/ea2bf2e1ba6863bb809fc2ff791744f308c4a26d/src/libraries/Descriptor.sol) - Generated with [forge doc](https://book.getfoundry.sh/reference/forge/forge-doc)

Describes NFT token positions

*Reference: https://github.com/RingProtocol/v3-periphery/blob/main/contracts/libraries/NFTDescriptor.sol*
...
Constructs the token URI for a v4 position NFT
...
Generates the first part of the description for a v4 position NFT
...
Generates the second part of the description for v4 position NFTs
...
Generates the name for a v4 position NFT
...
Generates the SVG image for a v4 position NFT
