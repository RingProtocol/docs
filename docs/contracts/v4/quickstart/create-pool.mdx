...
This page describes how to create pools in the current `FewToken + Uniswap v4` integration environment. It should not be read as evidence that Ring operates a separate native `Ring v4` AMM.
...
As a reference, concentrated-liquidity v3-style pools are configured with:
