...
Instead, Ring V2 adds this end-of-block price to a single cumulative-price variable in the core contract weighted by the amount of time this price existed. **This variable represents a sum of the Ring price for every second in the entire history of the contract.**
