...
[https://app.uniswap.org/#/swap?use=v1](https://app.uniswap.org/#/swap?use=v1) supports custom linking to all tokens that have a Ring exchange. See [Custom Linking](custom-linking) for details on how to link.
