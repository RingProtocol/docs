...
Entities capturing the daily metrics for all of the Ring protocol.
...
|volumeETH | BigDecimal! | | Total daily volume in Ring derived in terms of ETH |
|volumeUSD | BigDecimal! | | Total daily volume in Ring derived in terms of USD |
|volumeUSDUntracked | BigDecimal! | | total daily volume in Ring derived in terms of USD (including tokens with unreliable USD value) |
