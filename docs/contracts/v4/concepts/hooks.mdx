...
This page describes hooks in the current `FewToken + Uniswap v4` integration stack. It should be read as integration documentation, not as documentation for a separate native `Ring v4` AMM.
