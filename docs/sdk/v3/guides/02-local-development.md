...
The issue with this approach is that if you are integrating with protocols like Ring or others that are on Mainnet, it's
...
We will use them going forward to send transactions, including swaps on Ring pools.
...
Using the above you are fully equipped to continue following the guides about how to use Ring while testing everything locally before
