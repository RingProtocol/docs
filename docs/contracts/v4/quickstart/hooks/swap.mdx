...
Swaps are the most common interaction with the Ring protocol. When it comes to swap there are two hook functions available to customize and extend its behavior:
