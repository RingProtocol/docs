Provides validation for callbacks from Ring V3 Pools
...
Returns the address of a valid Ring V3 Pool

#### Parameters:

| Name      | Type    | Description                                                                       |
| :-------- | :------ | :-------------------------------------------------------------------------------- |
| `factory` | address | The contract address of the Ring V3 factory                                    |
