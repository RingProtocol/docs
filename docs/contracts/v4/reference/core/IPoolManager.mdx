...
The `IPoolManager` interface defines the main methods for interacting with the Ring V4 pool manager contract. It exposes the core _swap lifecycle_ operations
