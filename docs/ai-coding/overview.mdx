...
description: Ring docs are LLM-ready and help developers use Ring, FewToken, Ring Swap v2, and related integrations more efficiently.
---
...
You can provide your code editor with a llms.txt or llms-full.txt file to use Ring docs as context for your code.
...
```
https://docs.ring.exchange/v4-llms.txt
```
or

```
https://docs.ring.exchange/v4-llms-full.txt
```
3. Use @docs -> Ring to reference Ring docs in your chat.
...
```
@docs:https://docs.ring.exchange/v4-llms.txt
```
or

```
@docs:https://docs.ring.exchange/v4-llms-full.txt
```
