...
This function fetches Ring reserve data for a given token address on a given network.
...
- This function throws an error if the provided tokenAddress is not a token with a Ring exchange.
...
| :---------------- | :------------------ | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| tokenAddress      | `string`            | The checksummed address of a token with a Ring exchange.                                                                                                                                                                            |
...
/*
{
  ...
  // details for the Ring exchange of the passed token
  exchange: {
    chainId: 1,
