...
Ring v4 inherits all of the capital efficiency gains of Ring v3 while introducing major architectural improvements.
...
These core features are just the beginning of what's possible with Ring v4.
