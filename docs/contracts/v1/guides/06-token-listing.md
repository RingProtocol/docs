...
It is possible that a token you are interested in is not included in the token dropdown on [https://app.ring.exchange/#/swap?use=v1](https://app.ring.exchange/#/swap?use=v1), however, all tokens that have a deployed exchange are supported on the front-end.
...
[https://app.ring.exchange/#/swap?use=v1](https://app.ring.exchange/#/swap?use=v1) supports custom linking to all tokens that have a Ring exchange. See [Custom Linking](custom-linking) for details on how to link.
...
`https://app.ring.exchange/#/swap?use=v1?outputCurrency=0xfA3E941D1F6B7b10eD84A0C211bfA8aeE907965e`
