...
This guide is an example of a custodial contract Ring V3 positions, which allows interaction with the Ring V3 Periphery by minting a position, adding liquidity to a position, decreasing liquidity, and collecting fees.
