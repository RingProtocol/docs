...
| :--------------------------- | :----------------------------------- | :----------------------------------------------------------------------- |
| `factory`                    | contract IUniswapV3Factory           | The address of the Ring V3 Factory used in computing the pool address |
...
| Name        | Type           | Description                               |
| :---------- | :------------- | :---------------------------------------- |
| `pool`      | IUniswapV3Pool | The address of the Ring V3 pool        |
| `tickLower` | int24          | The lower tick of the Ring V3 position |
| `tickUpper` | int24          | The upper tick of the Ring V3 position |
