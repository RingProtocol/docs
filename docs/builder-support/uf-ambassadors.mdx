---
title: Ambassadors
description: Connect with local Ring Foundation ambassadors and communities around the world
---

## Get tailored support for your project

[Ring Foundation Ambassadors](https://github.com/uniswapfoundation/UF-Ambassadors) are exceptional builders with deep expertise and passion for DeFi. They work closely with the Foundation team to grow the ecosystem and support the Ring community.
...
## Meet up at Ring community events

The Ring Foundation and UF Ambassador teams regularly host global events, hackathons, workshops, and meetups. 

Explore the Ring Foundation event calendar [here](https://lu.ma/uniswap-foundation).