...
- We cannot change the boundaries of a given liquidity position using the Ring v3 protocol; `increaseLiquidity` can only increase the liquidity of a position.
