...
The automated market making algorithm used by Ring Swap.
See [x\*y=k](#x--y--k).
...
Smart contracts that are essential for Ring to exist. Upgrading to a new version of core would require a liquidity migration.
