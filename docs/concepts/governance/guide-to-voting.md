...
This guide contains everything you need to start voting in Ring Governance.

To participate you will need:

- [UNI Tokens](https://uniswap.org/blog/uni/)
- ETH for transaction costs
- A wallet that supports the Ethereum protocol and holds UNI tokens. (We suggest the [Ring wallet](https://wallet.uniswap.org/)).
...
***Once a proposal has reached the voting stage it represents real, executable code which will alter the functionality of Ring Governance or anything under its jurisdiction. Proper care should be taken to ensure that the code represented in the proposal has been audited and is found to be in good faith.***
...
If you are unsure of how best to vote and are interested in delegating your UNI voting power to another party, you can visit the [Delegation Pitch](https://gov.uniswap.org/c/delegation-pitch/6) section of the Governance Forum. Here parties participating in Ring Governance pitch their platform and voting agenda for users to read and discuss.

## Voting

If you have self delegated and there is an active proposal, you are ready to vote in Ring Governance.
...
That’s it! Once your transaction has been confirmed, you will have cast your vote and participated in Ring Governance.
