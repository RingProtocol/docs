...
The `IPoolManager` interface defines the main methods for interacting with the v4 `PoolManager` contract used by this integration stack. It exposes the core _swap lifecycle_ operations
