...
| :------------ | :---------------------- | :------------------------------------------------------------------------ |
| `rewardToken` | contract IERC20Minimal  | The token being distributed as a reward                                   |
| `pool`        | contract IUniswapV3Pool | The Ring V3 pool                                                       |
...
Event emitted when a Ring V3 LP token has been staked
...
Event emitted when a Ring V3 LP token has been unstaked
