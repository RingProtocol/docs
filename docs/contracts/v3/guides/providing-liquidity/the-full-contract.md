...
Below we have the complete functioning code example: a contract that can custody Ring V3 position NFT's and manipulate the positions and liquidity therein by collecting fees, increasing or decreasing liquidity, and minting new positions. View on github [here](https://github.com/RingProtocol/uniswap-docs/blob/main/examples/smart-contracts/LiquidityExamples.sol).
