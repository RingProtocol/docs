...
In the current version of the Ring Protocol Fee system, searchers can *permissionlessly* capture value from the system
...
* Ring v3 Fee [collection](./best-practices.mdx#collect-uniswap-v3-fees)
* Ring v2 LP Token [redemptions](./read-asset-balance.mdx#uniswap-v2-pool-protocol-fees)
