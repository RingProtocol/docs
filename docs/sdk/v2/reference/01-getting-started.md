...
The [source code is available in the Ring SDK monorepo](https://github.com/RingProtocol/sdks/tree/main/sdks/few-v2-sdk).

## Dependencies

The SDK installs a small number of dependencies ([package.json](https://github.com/RingProtocol/sdks/blob/main/sdks/few-v2-sdk/package.json)).
